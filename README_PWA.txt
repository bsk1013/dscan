...
[v4.6.31] 국소 교체 수정
- 안전병합으로 자동 채택된 핵심 사용자값(mainText/점수/결과/강평체크)은 Critical Runtime Journal에 즉시 write-through하여 병합 직후 generic persist가 예전값을 재적용하지 못하도록 보강.
- 실제 최종 입력테이블 renderRows의 연결사진 썸네일에 ‹ / ↻ / › 순서·회전 컨트롤을 직접 포함.
- 파트 강평 주요내용을 덮고 있던 후행 15px 강제 CSS를 21px 발표용 크기로 직접 교체.
